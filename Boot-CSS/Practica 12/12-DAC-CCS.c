...
*/
/*
Esta practica consiste en realizar un control DAC para variar el voltaje de una
salida analogica y visualizarlo en un LED.


---------------------Registros para configurar el modulo DAC-------------------
VREFCON1: Registro de configuracion de voltajes de referencia
...
#BYTE VREFCON1=0XF7C                  //Posicion del registro en la memoria del pic18f45k50
#BYTE VREFCON2=0XF7B
...
void main()
{
   VREFCON1 = 0b10100000; //Registro de configuracion de voltajes de referencia de DAC
   set_tris_b (0x00); //Configuracion del puerto B como salidas digitales
   while (true)
   {
