...
*/
/**************************************************************************
Esta practica consiste en variar la velocidad de un motor usando el modulo
PWM.
**************************************************************************/
...
void main()
{
   ...
   while (TRUE)
   {
      output_bit (IN_1, 1);     //Direccion del motor
      output_bit (IN_2, 0) ;
      SUBE = 1;

      while (VELOCIDAD < 1020&&SUBE)
      {
         //Se va incrementando del valor en el PWM hasta el maximo
      ...
      {
         //Se va reduciendo el valor en el PWM hasta el minimo
      ...
      output_bit (IN_1, 0);     //Direccion del motor
      output_bit (IN_2, 1) ;
      SUBE = 1;
