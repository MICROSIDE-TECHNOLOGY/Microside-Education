...
*/
/**************************************************************************
Esta practica consiste en realizar la medicion de temperatura por medio de un 
...
#include<ds1820.c>                      //Se incluyela libreria del driver para el manejo del sensor DS18B20
...
{
  port_b_pullups(0xff);
  lcd_init();      // Comandos de inicializacion del lcd.
