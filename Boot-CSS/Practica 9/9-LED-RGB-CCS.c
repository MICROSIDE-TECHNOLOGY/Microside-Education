...
#define LEDR PIN_B0        //Pin donde esta conectado el LED de X-TRAINER
#define LEDV PIN_B1        //Pin donde esta conectado el LED de X-TRAINER
#define LEDA PIN_B2        //Pin donde esta conectado el LED de X-TRAINER
